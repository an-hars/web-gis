    ...
    <head>
     ...
     <title>GIS <?= $judul ?></title>
      ...
      <link href="<?= base_url('SB_ADMIN/css/styles.css') ?>" rel="stylesheet" />
        ...
        <!-- Leaflet CSS (pastikan sudah ada) -->
<link rel="stylesheet" href="https://unpkg.com/leaflet@1.9.4/dist/leaflet.css" />

<!-- Leaflet JS (pastikan sudah ada) -->
...
<script src="https://unpkg.com/leaflet-control-geocoder/dist/Control.Geocoder.js"></script>
    ...
    Dashboard
                            ...
                            <div class="sb-sidenav-menu-heading">Tanpa data base</div>
...
<?php endif; ?>
                ...
                <footer class="py-4 bg-light mt-auto">
                    <div class="container-fluid px-4">
                        <div class="d-flex align-items-center justify-content-between small">
                            <div class="text-muted">Copyright &copy; WEB ANHAR</div>
                            <div>
       ...
       <script src="<?= base_url('BS_ADMIN/') ?>"></script>
